...
public class MainActivity extends AppCompatActivity {
    ...
    Button button_0, button_1, button_2, button_3, button_4, button_5, button_6, button_7, button_8, button_9, button_Add, button_Sub,
            button_Mul, button_Div, button_Equ, button_Del, button_Dot, button_Remainder,in_words;
    Toast makeToast;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        in_words = (Button) findViewById(R.id.inwords);
        ...
        button_Add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (edittext1.getText().length() != 0) {
                    mDblVal1 = Float.parseFloat(edittext1.getText() + "");
                    Add = true;
                    deci = false;
        ...
        in_words.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {

                String numberz =edittext1.getText().toString();
                try {
                    final long number = Long.parseLong(numberz);
                    String returnz = ToWords.convert(number);
                    edittext1.setText(returnz);
                } catch ( NumberFormatException e) {
                    //Toast.makeText("illegal number or empty number" ,Toast.LENGTH_LONG);
                    Toast.makeText(getApplicationContext(),"llegal number or empty number",Toast.LENGTH_SHORT);
                    makeToast.show();
                }
        ...
        button_Equ.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (Add || Sub || Multiply || Divide || Remainder) {
                    mDblVal2 = Float.parseFloat(edittext1.getText() + "");
                }

                if (Add) {

                    edittext1.setText(mDblVal1 + mDblVal2 + "");
                    Add = false;
                }
